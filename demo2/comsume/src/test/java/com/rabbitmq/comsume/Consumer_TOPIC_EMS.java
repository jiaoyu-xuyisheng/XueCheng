...
public class Consumer_TOPIC_EMS {
    //队列的名字
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
            ...
            channel.exchangeDeclare(EXCHANGE_TOPICS_INFORM,BuiltinExchangeType.TOPIC); //创建一个交换机
            ...
            channel.queueBind(QUEUE_INFORM_EMS,EXCHANGE_TOPICS_INFORM,ROUTING_KEY_EMS);   //* 1、队列名称 * 2、交换机名称 * 3、路由key
